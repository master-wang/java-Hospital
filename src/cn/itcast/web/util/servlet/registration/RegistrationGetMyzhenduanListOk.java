...
@WebServlet("/registrationGetMyzhenduanListOk")
public class RegistrationGetMyzhenduanListOk extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        dao.GetMyzhengduanListOk(Integer.parseInt(r_id));
        List list = dao.GetMyzhengduanList(Integer.parseInt(uu_id));
